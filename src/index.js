...
class Ex1 extends React.Component {
    constructor(props) {
        ...
        this.state = {
            items: [
                { id: 1, text: "щось 1", isChecked: false },
                { id: 2, text: "щось 2", isChecked: false },
                { id: 3, text: "щось 3", isChecked: false },
                { id: 4, text: "щось 4", isChecked: false }
            ]
        };
    }
...
class Ex2 extends React.Component {
    state = {
        employees: [
            ...
            { id: 3, firstName: 'Bob', lastName: 'Smith', salary: 4000, isChecked: true },
            { id: 4, firstName: 'Alice', lastName: 'Johnson', salary: 7000, isChecked: true }
        ],
        totalSalary: 0
    };
...
class Ex3 extends React.Component {
    state = {
        array: ["Абзац 1", "Абзац 2", "Абзац 3", "Абзац 4"],
    ...
    constructor(props) {
        ...
        this.state = {
            routes: [
                { id: 1, name: 'Карпати' },
                { id: 2, name: 'Крим' },
                { id: 3, name: 'Карпати на велосипеді' },
            ],
    ...
    render() {
        ...
        return (
            <div>
                ...
                <p>
                    {selectedRouteId
                        ? `Вибраний маршрут: ${selectedRoute.name}`
...
class Ex9 extends React.Component {
    constructor(props) {
        ...
        this.state = {
            employees: [
                { id: 1, firstName: 'Іван', lastName: 'Іванов', salary: 1000 },
                { id: 2, firstName: 'Петро', lastName: 'Петров', salary: 1200 },
                { id: 3, firstName: 'Микола', lastName: 'Миколаєв', salary: 800 },
                { id: 4, firstName: 'Василь', lastName: 'Васильченко', salary: 1500 },
            ],
            sortField: '',
            sortDirection: 'asc',
        };
